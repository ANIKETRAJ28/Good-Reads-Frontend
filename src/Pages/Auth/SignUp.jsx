        ...
        <Layout>
            <div className="h-[100vh] flex flex-col justify-center">
                <div className="flex flex-col items-center gap-4">
                    <h1 className="text-4xl text-white">Create a new account</h1>
                    <div>
                        <span className="text-white">Already have an account ?</span>
                        <Link to="/signin">
                            <button className="btn btn-success rounded-md px-4 py-0 mx-4 hover:bg-green-500 transition-all ease-in-out duration-500">Sign In</button>
                        </Link>
                    </div>
                </div>
